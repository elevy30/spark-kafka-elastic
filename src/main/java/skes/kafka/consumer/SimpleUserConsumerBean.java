...
@Slf4j
@Component
public class SimpleUserConsumerBean {

    @Value("${user.consumer.name}")
    ...
    @Autowired
    public SimpleUserConsumerBean(ConsumerProps consumerProps) {
        this.consumerProps = consumerProps;
    }

    @PostConstruct
    public void init() throws IOException {
        log.info("Start SimpleUserConsumerBean");
